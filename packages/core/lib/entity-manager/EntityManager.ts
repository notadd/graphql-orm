...
export class EntityManager {
          ...
          */
         hasId(
           targetOrEntity: any | Function | string,
           maybeEntity?: any
         ): boolean {
           const target =
             arguments.length === 2
         ...
         findQb<Entity>(
           ...
           const db = FindOptionsUtils.applyFindManyOptionsOrConditionsToQueryBuilder(
             qb,
             optionsOrConditions
           );
           return db;
         ...
         async findAndCount<Entity>(
           ...
           const item = FindOptionsUtils.applyFindManyOptionsOrConditionsToQueryBuilder(
             qb,
             optionsOrConditions
           );
         ...
         async findOneOrFail<Entity>(
           ...
           return this.findOne<Entity>(
             ...
             if (value === undefined) {
               return Promise.reject(
                 new EntityNotFoundError(entityClass, idOrOptionsOrConditions)
               );
             }
